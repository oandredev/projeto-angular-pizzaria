...
```
  ...
  Caso alterações ocorram na main durante o seu trabalho, significa que sua branch é main "antiga" do que main, logo para evitar conflitos futuros, 
use os seguintes comandos para sincronizar a main com seu código atual (mesmo que não tem sido alterados os mesmos arquivos)
...
```
Envia as alterações para o Git, onde o destino é a Branch nova que foi criado localmente e que agora vai se torna remota também
```bash
